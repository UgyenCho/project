{{-- PASTE THIS ENTIRE CODE INTO resources/views/navigation-menu.blade.php --}}
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                {{-- ******** START: Settings Dropdown (User Profile) ******** --}}
                {{-- This single block renders the only user profile dropdown --}}
                @auth
                <div class="ms-3 relative">
                ...
                @endauth
                {{-- ******** END: Settings Dropdown (User Profile) ******** --}}
