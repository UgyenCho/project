        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200 space-y-6">
                    ...
                    {{-- Back Button --}}
                    <div class="mb-4">
                        <a href="{{ route('hod.dashboard') }}#form-status" class="inline-flex items-center px-4 py-2 bg-gray-500 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring ring-gray-300 disabled:opacity-25 transition ease-in-out duration-150">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @foreach ($requisition->items as $index => $item)
                                        <tr class="{{ $loop->odd ? 'bg-white' : 'bg-gray-50' }}">
                                            ...
                                            <td class="px-4 py-2 text-sm text-gray-600">{{ $item->remarks ?? '--' }}</td>
                                             {{-- Optional: Add Issued Qty if needed --}}
